...
-> Terminal -> Preferences -> General -> Set "/usr/local/Cellar/bash/5.0.2/bin/bash" as "Shell open with -> Command (complete path)"
...
$ sudo bash -c 'echo /usr/local/Cellar/bash/5.0.2/bin/bash >> /etc/shells'
$ chsh -s /usr/local/Cellar/bash/5.0.2/bin/bash
